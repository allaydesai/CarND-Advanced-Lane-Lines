...
#    cv2.imwrite('output_images/thresh_img.jpg',thresh_img)
...
#
    ...
    radius_of_curvature = helperFunction.lane_curvature(left_fit, right_fit)
    center_calc = helperFunction.dist_from_center(frame, left_fitx, right_fitx)
...
#    cv2.imwrite('output_images/newwarp.jpg',newwarp)


    result = cv2.addWeighted(frame, 1, newwarp, 0.3, 0)
    cv2.putText(result, 'Radius of Curvature: %.2fm' % radius_of_curvature, (20, 40),
